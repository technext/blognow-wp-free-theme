 ...
 * @since      1.0.0
 */
class blognow_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-blognow-random widget_posts_thumbnail',
			'description' => __( 'Display random posts with thumbnails.', 'blognow' )
		);

		// Create the widget.
		parent::__construct(
			'blognow-random',                                   // $this->id_base
			__( '&raquo; Random Posts', 'blognow' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Random Posts', 'blognow' ),
			'limit'     => 5,
			'show_date' => true
		);
