 ...
 * @since      1.0.0
 */
class blognow_Views_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-blognow-views widget_posts_thumbnail',
			'description' => __( 'Display the most viewed posts with thumbnails.', 'blognow' )
		);

		// Create the widget.
		parent::__construct(
			'blognow-views',                                        // $this->id_base
			__( '&raquo; Most Viewed Posts', 'blognow' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( 'Most Viewed Posts', 'blognow' ),
			'limit'     => 5,
			'show_date' => true
		);
