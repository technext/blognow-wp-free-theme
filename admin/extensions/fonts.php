...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'blognow' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'blognow' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'blognow' ),
		'cyrillic'     => __( 'Cyrillic', 'blognow' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'blognow' ),
		'devanagari'   => __( 'Devanagari', 'blognow' ),
		'greek'        => __( 'Greek', 'blognow' ),
		'greek-ext'    => __( 'Greek Extended', 'blognow' ),
		'khmer'        => __( 'Khmer', 'blognow' ),
		'latin'        => __( 'Latin', 'blognow' ),
		'latin-ext'    => __( 'Latin Extended', 'blognow' ),
		'vietnamese'   => __( 'Vietnamese', 'blognow' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'blognow' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'blognow' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'blognow' ),
